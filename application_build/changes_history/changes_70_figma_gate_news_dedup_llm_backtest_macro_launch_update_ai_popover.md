...
> **이전 위치:** `changes_history/changes_15_figma_gate_news_dedup_llm_backtest_macro_launch_update_ai_popover.md` (루트 디렉터리)  
> **통합일:** 2026-06-17 (재넘버링: changes_15 → changes_70)
